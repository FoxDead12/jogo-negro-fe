    ...
    return (
        ...
        <>
            ...
            <form onSubmit={onFormSubmit} className='bg-gray-200 mt-8 p-4 w-full max-w-[600px] rounded-md shadow-md shadow-gray-500 flex flex-col justify-between text-center'>
                ...
                <h3 className='text-lg md:text-2xl mb-4 font-bold uppercase text-gray-700'>Fala connosco</h3>
  ...
  return (
      <section className='rleative flex flex-col items-center justify-center bg-gray-800 mt-24 p-4' id='contactos'>
          ...
          <div className='relative sm:w-[95%] md:w-[70%] m-auto mt-20 pt-12 flex items-start justify-around border-t-[1px] flex-col xl:flex-row'>
              ...
              <ul className='mt-8'>
                  <h4 className='text-2xl text-gray-100 uppercase font-bold mb-4'>Encontra-nos</h4>
              ...
              <ul className='mt-8'>
                  <h4 className='text-2xl text-gray-100 uppercase font-bold mb-4'>As nossas redes</h4>
